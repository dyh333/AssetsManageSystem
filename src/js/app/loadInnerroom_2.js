 ...
 */
define(['jquery', 'url', 'three', 'orbitControls', 'objloader', 'terraformer', 'terraformer_wkt_parser', 'loadBuildInitParam'],
    function ($, url, three, orbitControls, objloader, terraformer, terraformer_wkt_parser, loadBuildInitParam) {
        var bldg_id = url('?bldgId');
        var floor = url('?floor');

        var center = url('?center').split(",");
