 ...
 */
define(['jquery', 'url', 'three', 'orbitControls', 'objloader', 'terraformer', 'terraformer_wkt_parser', 'postal', 'amplify'],
    function ($, url, three, orbitControls, objloader, terraformer, terraformer_wkt_parser, postal, amplify) {
